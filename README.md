...
Development Environment
	...
	•	Microsoft Visual Studio 2022 Build Tools (C++ compiler)
	•	Developer Command Prompt for compiling and executing the program
	•	GitHub for version control and project hosting
	•	Programming Language:This project was written in C++, one of the most widely used programming languages for software     development.The program uses standard input/output libraries to print text to the console.
